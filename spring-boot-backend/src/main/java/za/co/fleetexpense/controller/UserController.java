...
public class UserController {
    ...
    /**
     * Get all users in the current organization for recipient selection.
     * Used for tax profile recipient dropdown.
     */
    @GetMapping("/organization")
    public ResponseEntity<List<User>> getOrganizationUsers(@AuthenticationPrincipal UserPrincipal principal) {
        List<User> users = userRepository.findByOrganizationId(principal.getOrganizationId());
