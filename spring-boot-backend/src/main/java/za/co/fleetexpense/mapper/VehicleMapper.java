...
public interface VehicleMapper {
    ...
    @Mapping(source = "operationalBaselineOdometer", target = "operationalBaselineOdometer")
    ...
    @Mapping(target = "operationalBaselineOdometer", source = "operationalBaselineOdometer")
