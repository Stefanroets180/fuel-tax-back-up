...
public class PermissionService {
    ...
    // ─── ODOMETER MANAGEMENT ───
    private static final Map<String, Set<String>> ODOMETER_MANAGEMENT_DEFAULTS = Map.ofEntries(
            Map.entry("CORRECT_BASELINE", Set.of("MANAGER", "ADMIN"))
    );
    ...
    // ─── TAX PROFILE ───
    private static final Map<String, Set<String>> TAX_PROFILE_DEFAULTS = Map.ofEntries(
    ...
    private static final Map<String, Map<String, Set<String>>> DEFAULTS = Map.of(
            ...
            "ODOMETER_MANAGEMENT", ODOMETER_MANAGEMENT_DEFAULTS,
            "REPORT_EXPORT", REPORT_EXPORT_DEFAULTS,
            "TAX_PROFILE", TAX_PROFILE_DEFAULTS
    );
