...
public class ReportExportService {
    ...
    public ReportExportDTO requestExport(UUID organizationId, UUID userId, ReportExportRequest request) {
        ...
        // Resolve calculation method using canonical hierarchy (TAX_CALCULATION only)
        TaxCalculationMethod resolvedMethod = null;
        if (request.getReportType() == ReportExportType.TAX_CALCULATION) {
            TaxCalculationMethod requestedMethod = request.getCalculationMethod();
            TaxCalculationMethod organizationDefault = organization.getDefaultTaxCalculationMethod();
            resolvedMethod = taxCalculationService.resolveCalculationMethod(requestedMethod, organizationDefault);
        }
