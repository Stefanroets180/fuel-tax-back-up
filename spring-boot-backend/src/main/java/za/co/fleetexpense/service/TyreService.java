...
public class TyreService {
    ...
    public Tyre create(Tyre tyre) {
        ...
        // Phase 1: Tyre mutation hooks removed from TyreService
        // Canonical operational query reads Expense.odometerReading, not Tyre.purchaseOdometer
        // Mutation hooks are in ExpenseService.updateTyreExpense() where Expense.odometerReading is persisted
    ...
    public void delete(UUID id) {
        ...
        // Phase 1: Tyre mutation hooks removed from TyreService
        // Canonical operational query reads Expense.odometerReading, not Tyre.purchaseOdometer
        // Mutation hooks are in ExpenseService where Expense.odometerReading is persisted
    }
}
